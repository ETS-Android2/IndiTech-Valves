...
public class AumaActuatorFragment extends Fragment {

    private EditText wkrNum;
    Bitmap bitmap;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_auma_actuator, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(requireActivity(), new String[]{WRITE_EXTERNAL_STORAGE}, PackageManager.PERMISSION_GRANTED);

        wkrNum = view.findViewById(R.id.wr_number);
        ...
        timeStamp = "AA"+ TimeUnit.MILLISECONDS.toSeconds(System.currentTimeMillis());
        generateBarcode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (TextUtils.isEmpty(wkrNum.getText())){
                    ...
                    try {
                        ...
                        data.put("work_num", Objects.requireNonNull(wkrNum.getText()).toString());
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        ...
                                        printBarcode.setOnClickListener(new View.OnClickListener() {
                                            @Override
                                            public void onClick(View v) {
                                                //File  pFile = new File(Environment.getExternalStorageDirectory().getPath(), timeStamp+".pdf");
                                                //Uri path = FileProvider.getUriForFile(requireActivity(), requireActivity().getApplicationContext().getPackageName() + ".provider", pFile);
