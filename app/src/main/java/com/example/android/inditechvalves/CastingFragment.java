...
public class CastingFragment extends Fragment {
    private EditText heatnumber,size,cClass,typeOfCasting,materialOfConstruction;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(requireActivity(), new String[]{WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE}, PackageManager.PERMISSION_GRANTED);

        heatnumber = view.findViewById(R.id.heat_number);
        size = view.findViewById(R.id.size);
        cClass = view.findViewById(R.id.class_text);
        typeOfCasting = view.findViewById(R.id.casting_type);
        materialOfConstruction = view.findViewById(R.id.material_of_construction);
        ...
        timeStamp = "CA" + TimeUnit.MILLISECONDS.toSeconds(System.currentTimeMillis());

        generateBarcode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (TextUtils.isEmpty(heatnumber.getText()) || TextUtils.isEmpty(size.getText()) || TextUtils.isEmpty(cClass.getText()) || TextUtils.isEmpty(typeOfCasting.getText()) || TextUtils.isEmpty(materialOfConstruction.getText())) {
                    ...
                    try {
                        ...
                        data.put("heatNo", Objects.requireNonNull(heatnumber.getText()).toString());
                        data.put("bar_url", encodeImage);
                        data.put("material_of_const", Objects.requireNonNull(materialOfConstruction.getText()).toString());
                        data.put("name_of_material","Casting");
                        data.put("size", Objects.requireNonNull(size.getText()).toString());
                        data.put("type", Objects.requireNonNull(typeOfCasting.getText()).toString());
                        data.put("cls_casting", Objects.requireNonNull(cClass.getText()).toString());
